...
Text::Pipe::List::Shift - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::List::Shift->new;

=head1 DESCRIPTION

Text::Pipe::List::Shift inherits from L<Text::Pipe::Base>.
...
This document describes version 0.05 of L<Text::Pipe::List::Shift>.
