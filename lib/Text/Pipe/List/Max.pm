...
Text::Pipe::List::Max - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::List::Max->new;

=head1 DESCRIPTION

Text::Pipe::List::Max inherits from L<Text::Pipe::Base>.
...
This document describes version 0.05 of L<Text::Pipe::List::Max>.
