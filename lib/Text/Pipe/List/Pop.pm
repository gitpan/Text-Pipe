...
Text::Pipe::List::Pop - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::List::Pop->new;

=head1 DESCRIPTION

Text::Pipe::List::Pop inherits from L<Text::Pipe::Base>.
...
This document describes version 0.06 of L<Text::Pipe::List::Pop>.
