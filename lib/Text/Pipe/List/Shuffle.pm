...
Text::Pipe::List::Shuffle - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::List::Shuffle->new;

=head1 DESCRIPTION

Text::Pipe::List::Shuffle inherits from L<Text::Pipe::Base>.
...
This document describes version 0.05 of L<Text::Pipe::List::Shuffle>.
