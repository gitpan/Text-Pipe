...
Text::Pipe::Say - Common text filter API
...
Text::Pipe::Say inherits from L<Text::Pipe::Base>.
...
This document describes version 0.06 of L<Text::Pipe::Say>.
