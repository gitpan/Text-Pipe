package Text::Pipe::UppercaseFirst;
...
Text::Pipe::UppercaseFirst - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::UppercaseFirst->new;

=head1 DESCRIPTION

Text::Pipe::UppercaseFirst inherits from L<Text::Pipe::Base>.
...
This document describes version 0.05 of L<Text::Pipe::UppercaseFirst>.
