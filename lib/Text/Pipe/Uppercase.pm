...
Text::Pipe::Uppercase - Common text filter API

=head1 SYNOPSIS

    Text::Pipe::Uppercase->new;

=head1 DESCRIPTION

Text::Pipe::Uppercase inherits from L<Text::Pipe::Base>.
...
This document describes version 0.05 of L<Text::Pipe::Uppercase>.
